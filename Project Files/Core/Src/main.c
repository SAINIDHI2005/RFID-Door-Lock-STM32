...
{
	uint32_t pulse_length= 451+ (angle * (2252 - 451)/180);
  ...
  while (1)
  {
            ...
            if (status == MI_OK)  // Card detected
            {
                ...
                if (status == MI_OK)
                {
                    ...
                    if ((str[0]==86)&&(str[1]==66)&&(str[2]==242)&&(str[3]==143)&&(str[4]==105))
                    {
                        Lcd_cursor(&lcd, 0, 1);
                    ...
                    else if ((str[0]==74)&&(str[1]==123)&&(str[2]==57)&&(str[3]==6)&&(str[4]==14))
                    {
                        Lcd_cursor(&lcd, 0, 1);
                        Lcd_string(&lcd, "ACCESS GRANTED ");
            ...
            {
                // No card detected; optional to keep LCD idle
                Lcd_cursor(&lcd, 0, 1);
                Lcd_string(&lcd, "DOOR LOCKED    ");
                HAL_Delay(200);
            }
